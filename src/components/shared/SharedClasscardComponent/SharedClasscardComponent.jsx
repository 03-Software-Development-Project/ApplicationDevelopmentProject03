        ...
        renderItem={({item: classItem}) => (
          <View style={styles.classCard}>
            ...
            <View style={{paddingVertical: 8}}>
              <Text style={[styles.classCardTitle, typography['body.large.medium']]}>
                {classItem.courseTitle}
              </Text>
              <View
                style={{paddingVertical: 4, flexDirection: 'row', alignItems: 'center', flex: 1}}>
                <Image
                  style={{width: 20, height: 20, marginRight: 4}}
                  source={require('../../../assets/icons/@calendar_icon.png')}
                />
                <Text style={[styles.classCardDate, typography['body.medium.regular']]}>
