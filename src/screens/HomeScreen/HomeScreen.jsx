    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView>
        <View style={styles.headerView}>
          <Text style={[typography['heading.h4'], {fontWeight: 700}, {flex: 1}]}>
            Course in class
          </Text>
            ...
            {classes.map((classItem) => (
              <View
                ...
                <View style={{alignItems: 'center', justifyContent: 'center'}}>
                  <View
                    style={{width: '30%', borderRadius: 999, overflow: 'hidden', marginBottom: 12}}>
                    <Text
                      style={[
                  ...
                  <View style={[{paddingBottom: 56}]}>
                    <Text
                      style={[typography['heading.h4'], {textAlign: 'center'}, {fontWeight: 600}]}>
        ...
        <View style={styles.viewcontainer}>
          <View style={styles.section}>
            <Text style={[typography['heading.h6'], styles.sectionTitle]}>Category</Text>
            <Text style={[typography['body.medium.regular'], styles.sectionSeeMore]}>
              All Topic
            </Text>
          </View>
              ...
              {category.slice(0, 3).map((categoryItem) => (
                <View
                  ...
                  <View style={{paddingHorizontal: 12}}>
                    <Text style={[typography['body.medium.semibold'], styles.categoryName]}>
                      {categoryItem.categoryTitle}
                    </Text>
                    <Text style={[typography['body.small.regular'], styles.categoryDescription]}>
        ...
        <View style={styles.viewcontainer}>
          ...
          <SharedClasscardComponent></SharedClasscardComponent>
        </View>
      </ScrollView>
    </SafeAreaView>
  )
